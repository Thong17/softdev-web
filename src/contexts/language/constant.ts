export const languages = {
  English: {
    ...
    HERO_BADGE: 'Trusted Stationery Store',
    SHOP_NOW: 'Shop Now',
  ...
  Khmer: {
    ...
    HERO_BADGE: 'ហាងសម្ភារៈការិយាល័យដែលអាចទុកចិត្តបាន',
    SHOP_NOW: 'ទិញឥឡូវនេះ',
    EXPLORE_DEALS: 'មើលការបញ្ចុះតម្លៃ',
    OUR_CATEGORIES: 'ប្រភេទផលិតផល',
    OUR_BRANDS: 'ម៉ាកយីហោរបស់យើង',
    ALL: 'ទាំងអស់',
    SHOW_ALL: 'មើលទាំងអស់',
    SHOW_LESS: 'មើលតិចជាងនេះ',
    FEATURED_PRODUCTS: 'ផលិតផលពិសេស',
    SORT_NEWEST: 'ថ្មីបំផុត',
    SORT_PRICE_LOW_HIGH: 'តម្លៃទាបទៅខ្ពស់',
    SORT_PRICE_HIGH_LOW: 'តម្លៃខ្ពស់ទៅទាប',
    NO_CATEGORIES_AVAILABLE: 'មិនទាន់មានប្រភេទផលិតផលនៅឡើយទេ។',
    NO_BRANDS_AVAILABLE: 'មិនទាន់មានម៉ាកយីហោនៅឡើយទេ។',
    NO_PRODUCTS_AVAILABLE: 'មិនទាន់មានផលិតផលនៅឡើយទេ។',
